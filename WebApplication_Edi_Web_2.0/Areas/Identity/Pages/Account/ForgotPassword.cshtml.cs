...
namespace WebApplication_Edi_Web_2._0.Areas.Identity.Pages.Account
{
    public class ForgotPasswordModel : PageModel
    {
        ...
        public ForgotPasswordModel(UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signinMgr)
        {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            if (ModelState.IsValid)
            {
                ...
                var link = Url.Page("/Account/ResetPassword", "ResetPassword", new { code, email = user.Email }, Request.Scheme);
