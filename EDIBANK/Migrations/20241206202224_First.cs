        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ip_remota = table.Column<string>(type: "varchar(50)", nullable: true),
                    modulo = table.Column<string>(type: "varchar(50)", nullable: true),
                    operacion = table.Column<string>(type: "varchar(50)", nullable: true),
                    comentarios = table.Column<string>(type: "varchar(50)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "f007f8e5-f114-4520-b016-010f3e3ebcfe", null, "User", "User" },
                    { "f863b756-0d6e-4649-bc9a-0b5fc3ad9c1a", null, "Admin", "Admin" }
                });
